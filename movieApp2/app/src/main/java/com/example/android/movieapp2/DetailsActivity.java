...
import com.example.android.movieapp2.Adapters.CastAdapter;
import com.example.android.movieapp2.Adapters.ReviewsAdapter;
import com.example.android.movieapp2.Adapters.TrailerAdapter;
import com.example.android.movieapp2.Database.MovieDatabase;
import com.example.android.movieapp2.Interface.MovieInterface;
import com.example.android.movieapp2.Models.Cast;
...
import com.example.android.movieapp2.Models.Trailer;
import com.example.android.movieapp2.Network.NetworkClass;
import com.example.android.movieapp2.Utils.AppExecutors;
import com.example.android.movieapp2.Utils.MovieUtils;
...
import static com.example.android.movieapp2.Utils.Constants.FAV_MOVIE_KEY;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MovieInterface movieService = NetworkClass.getRetrofitInstance().create(MovieInterface.class);
            ...
            if (getIntent().hasExtra(SELECTED_MOVIE_TO_SEE_DETAILS)) {
                ...
                AppExecutors.getExecutorInstance().getDiskIO().execute(() -> {
                    ...
                    if (isFavorite) {
                        ...
                        runOnUiThread(() -> favBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.favourite_selected)));
                    } else {
                        runOnUiThread(() -> favBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.favourite_unselected)));
                    }
                });
            }
        }
    ...
    private void onFavButtonClicked() {
        AppExecutors.getExecutorInstance().getDiskIO().execute(() -> {
            ...
            if (isFavorite) {
                ...
                runOnUiThread(() -> {
                    favBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.favourite_unselected));
                ...
                runOnUiThread(() -> {
                    ...
                    favBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.favourite_selected));
                });
            }
    ...
    private void getMovieCast(Integer id) {
        if (MovieUtils.getInstance().isNetworkAvailable(this)) {
            if (retrofit == null) {
                retrofit = NetworkClass.getRetrofitInstance();
            }
